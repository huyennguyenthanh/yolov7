...
def detect(files, model, visualize=True, save_txt=False, visual_folder="/home/nguyen.thanh.huyenb/yolov7/visualize/2"):
...
if __name__ == "__main__":
    files = glob("/home/nguyen.thanh.huyenb/yolov7/polyp_dataset/TestDataset/ETIS-LaribPolypDB/images/*")
    # files = "/home/nguyen.thanh.huyenb/yolov7/polyp_dataset/TestDataset/Kvasir/images/cju16ach3m1da0993r1dq3sn2.png"
    print(f"Found {len(files)} images")

    # load model
    weight_path = "/home/nguyen.thanh.huyenb/yolov7/yolov7_train/runs/train/yolov7-havard-polyp-1-label-/weights/best.pt"
    ...
    visual_folder = "/home/nguyen.thanh.huyenb/yolov7/polyp_dataset/TestDataset/ETIS-LaribPolypDB/results_yolo_v7"
    if not os.path.exists(visual_folder):
        os.makedirs(visual_folder)
    detect(files, model, visualize=True, visual_folder=visual_folder)
