...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(
        ...
        try:
            if isinstance(path, list):
                path = path[0]
            if path.endswith("json") and isinstance(path, str):
    ...
    def __getitem__(self, index):
        ...
        hyp = self.hyp
        self.mosaic = self.mosaic and random.random() < hyp["mosaic"]
        if self.mosaic:
            # Load mosaic
    ...
    def collate_fn(batch):
        ...
        Returns:
            img: torch.Size([4, 3, 640, 640]),
            labels: torch.Size([7, 6]),
                 tensor([[0.00000, 0.00000, 0.96261, 0.86038, 0.07478, 0.24403],
                    [1.00000, 0.00000, 0.80279, 0.66611, 0.39441, 0.39360],
                    [2.00000, 0.00000, 0.88168, 0.38699, 0.18912, 0.14079],
                    [3.00000, 0.00000, 0.33931, 0.21226, 0.03599, 0.03545],
                    [3.00000, 0.00000, 0.15864, 0.21976, 0.03949, 0.03819],
                    [3.00000, 0.00000, 0.33047, 0.32494, 0.02751, 0.02201],
                    [3.00000, 0.00000, 0.19075, 0.35742, 0.03331, 0.03327]]))
            paths: list[path]
            ['/mnt/disk1/nguyen.thanh.huyenb/PolypsSet/PolypsSet/train2019/images/10005.jpg',
            '/mnt/disk1/nguyen.thanh.huyenb/PolypsSet/PolypsSet/train2019/images/10010.jpg',
            '/mnt/disk1/nguyen.thanh.huyenb/PolypsSet/PolypsSet/train2019/images/10036.jpg',
            '/mnt/disk1/nguyen.thanh.huyenb/PolypsSet/PolypsSet/train2019/images/10038.jpg'],
